...
<table data-view="cards"><thead><tr><th>Key</th><th>Explanation</th><th data-type="select">Type</th></tr></thead><tbody><tr><td><code>id</code></td><td><p>A unique identifier of this object. </p><p>If not set, a random alphanumeric ID will be generated. </p><p>Supports the <code>$note</code> variable.</p></td><td></td></tr><tr><td><code>target_id</code></td><td><p><em><strong>For scene objects only.</strong></em> </p><p>When set, this object does not have its own entity form but controls the specified object instead. <a data-mention href="common-properties.md#using-target_id">#using-target_id</a></p><p>The target object must be of the <strong>same type</strong>.</p><p>Supports the <code>$note</code> variable.</p></td><td></td></tr><tr><td><code>parent_id</code></td><td><p><em><strong>For texts and sprites only.</strong></em> <br>When set, this object's movement follows the specified parent. (this object's position, rotation and scale will be attached to its parent) </p><p>Supports the <code>$note</code> variable.</p></td><td></td></tr><tr><td><code>time</code></td><td><p>The time at which this state should happen, measured in seconds. </p><p>This may not be equivalent to the true timing—see how an object's exact timing is calculated below.</p></td><td></td></tr><tr><td><code>relative_time</code></td><td>The relative time to the parent state</td><td></td></tr><tr><td><code>add_time</code></td><td>The relative time to the last defined state.</td><td></td></tr><tr><td><code>easing</code></td><td><p>The easing used when animating this object from the current state to the next state. </p><p>See <a href="https://easings.net/">https://easings.net/</a> for more info.</p><p>Default: <code>linear</code>.</p></td><td></td></tr><tr><td><code>destroy</code></td><td><p>If <code>true</code>, this object is destroyed when it fully transitions into this state. </p><p>It is recommended to destroy an object when you do not need to use it anymore, for performance.</p></td><td></td></tr><tr><td><code>states</code></td><td>Extra states of this object.</td><td></td></tr></tbody></table>
